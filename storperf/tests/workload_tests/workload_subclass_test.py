...
class WorkloadSubclassTest(unittest.TestCase):
    ...
    def test_local_name(self):
        ...
        self.assertEqual(workload.fullname, 
                         "rr.host.None.queue-depth.1.block-size.64k",
                         workload.fullname);
    ...
    def test_remote_name(self):
        ...
        self.assertEqual(workload.fullname, 
                         "rw.host.192-168-0-1.queue-depth.1.block-size.64k",
                         workload.fullname);
    ...
    def test_blocksize(self):
        ...
        self.assertEqual(workload.fullname, 
                         "rs.host.None.queue-depth.1.block-size.4k",
                         workload.fullname);
    ...
    def test_queue_depth(self):
        ...
        self.assertEqual(workload.fullname, 
                         "wr.host.None.queue-depth.8.block-size.64k",
                         workload.fullname);

    def test_name(self):
        workload = ws()
        self.assertEqual(workload.fullname, 
                         "ws.host.None.queue-depth.1.block-size.64k",
                         workload.fullname);
