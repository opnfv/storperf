...
from snaps.snaps.openstack.os_credentials import OSCreds
from snaps.snaps.config.stack import StackConfig
from snaps.snaps.openstack.create_stack import OpenStackHeatStack
from snaps.snaps.openstack.create_volume import OpenStackVolume, VolumeSettings
...
class StorPerfMaster(object):
    ...
    def __init__(self):
        ...
        stack_settings = StackConfig(name='StorPerfAgent',
    ...
    def create_stack(self):
        # (TODO) Use SNAPS equivalent of Volume Quotas
        self.heat_stack.create(block=True)
        self.stack_id = self.heat_stack.get_stack().id
    ...
    def execute_workloads(self, metadata={}):
        ...
        # (TODO) Keep a record of the number of VMs launched
