...
from snaps.openstack.utils import heat_utils, nova_utils, neutron_utils,\
    cinder_utils, glance_utils
...
class StorPerfMaster(object):
    ...
    def _get_stack_info(self):
        ...
        if self.heat_stack.get_stack() is not None:
            ...
            nova_cli = nova_utils.nova_client(self.os_creds)
            neutron_cli = neutron_utils.neutron_client(self.os_creds)
            ...
            server = nova_utils.get_server(
                nova_cli, neutron_cli,
                vm_inst_settings=vm1.instance_settings)
