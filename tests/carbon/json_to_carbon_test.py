...
class JSONToCarbonTest(unittest.TestCase):
    ...
    json_map_name_with_spaces = """{ "map with spaces" : { "key" : "value" } }"""
    json_list_name_with_spaces = """{ "list with spaces" : [{ "key" : "value" }] }"""
...
"""
    ...
    def test_to_string(self):
        ...
        self.assertEqual("7116", result["host.run-name.jobs.1.read.io_bytes"], result["host.run-name.jobs.1.read.io_bytes"])
    ...
    def test_single_text_key_space_element_no_prefix(self):
        ...
        self.assertEqual("value", result["key_with_spaces"], result["key_with_spaces"])
    ...
    def test_map_name_with_space_no_prefix(self):
        ...
        self.assertEqual("value", result["map_with_spaces.key"], result["map_with_spaces.key"])
    ...
    def test_list_name_with_space_no_prefix(self):
        ...
        self.assertEqual("value", result["list_with_spaces.1.key"], result["list_with_spaces.1.key"])
